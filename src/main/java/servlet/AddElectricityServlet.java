...
@WebServlet(name = "AddElectricityServlet", value = "/AddElectricityServlet")
public class AddElectricityServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (dao.addElectricity(conn, electricity)) {
                ...
                response.setHeader("Refresh", "3;url=/FYP1_war_exploded//pages/admin/resources/jsp/admin_addelectricity.jsp");
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
