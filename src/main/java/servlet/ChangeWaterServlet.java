...
@WebServlet(name = "ChangeWaterServlet", value = "/ChangeWaterServlet")
public class ChangeWaterServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (dao.ChangeWater(conn, water)) {
                ...
                response.setHeader("Refresh", "3;url=/FYP1_war_exploded//pages/admin/resources/jsp/admin_changewater.jsp");
            }
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
